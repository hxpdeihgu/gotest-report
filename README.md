...
```shell
$ go get -u github.com/hxpdeihgu/go-test-report/
```
...
- Add a GitHub Star
- Suggest [new features, ideas and optimizations](https://github.com/hxpdeihgu/go-test-report/issues)
- [Report issues](https://github.com/hxpdeihgu/go-test-report/issues)
